# Castalia permissionless membership acceptance record

Complete this record only after every gate passes. Do not put private keys,
passphrases, AWS credentials, or the contents of the recovery export here.

- Acceptance UTC:
- Owner/operator:
- Dregg deployed commit (40 hex):
- `dregg-node` SHA-256:
- Release tag and workflow run:
- SBOM SHA-256:

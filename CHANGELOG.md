...
- Reworded Clippy-sensitive doc continuations across shielded-transfer, escrow-market, execution-lease, and deos-view docs — restores the issue #3 Clippy advisory gate.
